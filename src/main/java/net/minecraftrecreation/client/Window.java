...
public class Window {
    ...
    public Window(String title, WindowOptions opts, Callable<Void> resizeFunc) {
        this(title,opts,resizeFunc,() -> null);
    }

    public Window(String title, WindowOptions opts, Callable<Void> resizeFunc, Callable<Void> onClose) {
        ...
        glfwSetErrorCallback((int errorCode, long msgPtr) ->
                System.err.printf("Error code [%d], msg [%s]", errorCode, MemoryUtil.memUTF8(msgPtr))
        );
    ...
    protected void resized(int width, int height) {
        ...
        try {
            ...
            logger.log(WARN, "Failed to resize the window.\n"+ new ExcParser(excp));
        }
    }
    ...
    public void setCloseCallback(Callable<Void> closeCallback) {
        this.closeCallback = closeCallback;
    }

    public Callable<Void> getCloseCallback() {
